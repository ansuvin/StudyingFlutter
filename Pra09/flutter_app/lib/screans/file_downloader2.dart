...
class FileDownLoaderPage2 extends StatefulWidget {
  final TargetPlatform platform;
  final String title;

  FileDownLoaderPage2({Key key, this.title, this.platform}) : super(key: key);

  @override
  _FileDownLoaderPage2 createState() => _FileDownLoaderPage2();
}

class _FileDownLoaderPage2 extends State<FileDownLoaderPage2> {
  final _documents = [
    {
